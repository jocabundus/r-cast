...
private:
    ...
    dim   _ceils(MAP_WIDTH*MAP_HEIGHT) as short
    dim  _colors(MAP_WIDTH*MAP_HEIGHT) as integer
    dim _ccolors(MAP_WIDTH*MAP_HEIGHT) as integer
...
public:
    ...
    declare function ceilcolors(x as integer, y as integer) as integer
    ...
    declare function setCeilColor(x as integer, y as integer, new_c as integer) as FlatMap ptr
    ...
    declare function getCeilColorAvg(x as integer, y as integer, size as integer) as integer
